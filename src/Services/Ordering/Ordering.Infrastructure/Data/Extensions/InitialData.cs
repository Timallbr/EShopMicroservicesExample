namespace Ordering.Infrastructure.Data.Extensions
{
    ...
    new List<Customer>
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "Timothy", "timallbr@gmail.com"),
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("Timothy", "Brown", "timallbr@gmail.com", "123 Happy Circle", "Angel Fire", "New Mexico", "87710", "United States");
                var address2 = Address.Of("john", "doe", "john@gmail.com", "No:1", "Broadway", "Nottingham", "08050", "England");

                var payment1 = Payment.Of("Timothy", "5555555555554444", "12/28", "355", 1);
